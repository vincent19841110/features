...
s.linkInternalFilters="javascript:,ellechina.com,elle.cn"
...
function s_doPlugins(s) {
	...
	/* Time Parting */
		s.prop11=s.getTimeParting('h','8'); // Set hour 
		s.prop12=s.getTimeParting('d','8'); // Set day 
		s.prop13=s.getTimeParting('w','8'); // Set weekday 
		s.eVar11=s.prop11;
		s.eVar12=s.prop12;
		s.eVar13=s.prop13;

	/* Internal Search Event Setting */
		if(s.prop11) s.events=s.apl(s.events,"event1",",",1);
